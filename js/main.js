define(['models/itemCollection', 'models/itemModel', 'jquery', 'chartjs', 'jqueryui', "charter", "widgets/itemFilter", "widgets/itemResults", "widgets/itemSearch", "widgets/itemTooltip"], function (ItemCollection, ItemModel, $, Chart) {
